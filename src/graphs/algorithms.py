...
# ---------------------------------------------------------------------------
# Funções estendidas — compatíveis com GrafoAeroportos e GrafoGenerico
# ---------------------------------------------------------------------------

def bfs_camadas(grafo: Any, origem: str) -> dict:
...
def dfs_ciclos(grafo: Any, origem: str) -> dict:
...
def bellman_ford(grafo: Any, origem: str) -> tuple:
    ...
    # V-ésima iteração detecta ciclo negativo
