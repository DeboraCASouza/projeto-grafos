...
def descrever_dataset(grafo: GrafoGenerico, nome: str, fonte: str) -> dict:
...
def _nos_por_grau(grafo: GrafoGenerico, excluir_isolados: bool = True) -> list:
...
def _executar_bfs(grafo: GrafoGenerico, fontes: list) -> dict:
    resultados = {}
    for src in fontes:
...
def _executar_dfs(grafo: GrafoGenerico, fontes: list) -> dict:
    resultados = {}
    for src in fontes:
        t0 = time.perf_counter()
...
def _executar_dijkstra(grafo: GrafoGenerico, pares: list) -> list:
    resultados = []
...
def _grafo_sintetico_pesos_negativos() -> GrafoGenerico:
    """
...
def _grafo_sintetico_ciclo_negativo() -> GrafoGenerico:
    """
...
def _executar_bellman_ford(grafo: GrafoGenerico) -> dict:
...
def executar_item2(grafo: GrafoGenerico) -> dict:
...
def executar_metricas_desempenho(grafo: GrafoGenerico, runs: int = 20) -> dict:
